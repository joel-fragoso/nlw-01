...
<h1 align="center">
    <img alt="Example" title="Example" src="./assets/ecoleta-web.png" width="100%" height="200px" />
    <img alt="Example" title="Example" src="./assets/ecoleta-mobile.png" width="100%" height="200px" />
</h1>
